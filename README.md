...
- 语言偏好：登录页可通过“中 / EN”即时切换中英文；设置页提供“简体中文 / 繁體中文 / English”三段选择，并把偏好保存到本地或当前云端账号。
...
登录页每次打开默认显示中文，并可在右上角切换为英文。语言切换保留 `MyAssist`、`Today’s Schedule`、`Task`、`Deadline` 和 `To Do List` 等既有英文产品词段。
